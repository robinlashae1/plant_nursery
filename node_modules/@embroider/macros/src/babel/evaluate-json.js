...
class Evaluator {
    ...
    evaluateMacroCall(path) {
        ...
        if (callee.referencesImport('@embroider/macros', 'dependencySatisfies')) {
            return { confident: true, value: (0, dependency_satisfies_1.default)(path, this.state) };
        }
        if (callee.referencesImport('@embroider/macros', 'moduleExists')) {
            return { confident: true, value: (0, module_exists_1.default)(path, this.state) };
        }
        if (callee.referencesImport('@embroider/macros', 'getConfig')) {
            return { confident: true, value: (0, get_config_1.default)(path, this.state, 'package') };
        }
        if (callee.referencesImport('@embroider/macros', 'getOwnConfig')) {
            return { confident: true, value: (0, get_config_1.default)(path, this.state, 'own') };
        }
        if (callee.referencesImport('@embroider/macros', 'getGlobalConfig')) {
            return { confident: true, value: (0, get_config_1.default)(path, this.state, 'getGlobalConfig') };
        }
